...
namespace WesleyAirlines.Controllers
{
    public class DestinationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DestinationID,Name,Country")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinationID,Name,Country")] Destination destination)
        {
